...
(function (global, factory) {
    ...
    function prependToElement(parent, content) {
        ...
        for (var newEl of newEls) {
            parent.insertBefore(newEl, afterEl);
        }
    }
    ...
    function insertAfterElement(refEl, content) {
        ...
        for (var newEl of newEls) {
            refEl.parentNode.insertBefore(newEl, afterEl);
        }
    }
    ...
    function findElements(container, selector) {
        ...
        var allMatches = [];
        for (var containerEl of containers) {
            var matches = containerEl.querySelectorAll(selector);
    ...
    function listenToHoverBySelector(container, selector, onMouseEnter, onMouseLeave) {
        ...
        return listenBySelector(container, 'mouseover', selector, function (ev, matchedChild) {
            if (matchedChild !== currentMatchedChild) {
                ...
                var realOnMouseLeave_1 = function () {
    ...
    function refineProps(rawProps, processors, defaults = {}, leftoverProps) {
        ...
        for (const [key, processor] of Object.entries(processors)) {
            ...
            if (rawValue !== undefined) {
                refined[key] = (processor === Function)
                    ? (typeof rawValue === 'function' ? rawValue : null)
                    : (processor ? processor(rawValue) : rawValue);
            } else {
                refined[key] = (defaults[key] !== undefined) ? defaults[key] : getDefaultForProcessor(processor);
            }
        }
        ...
        function getDefaultForProcessor(processor) {
            if (processor === String) {
                return '';
    ...
    ***************************************************************************** */
    ...
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (derived, base) { derived.__proto__ = base; }) ||
            function (derived, base) { for (var p in base) if (base.hasOwnProperty(p)) derived[p] = base[p]; };
    ...
    */
    ...
    function mergeProps(propObjs, complexProps) {
        ...
        function mergeComplexProps(name) {
            var complexObjs = [];
            for (var j = propObjs.length - 1; j >= 0; j--) {
                var val = propObjs[j][name];
        ...
        if (complexProps) {
            for (var i = 0; i < complexProps.length; i++) {
                var name = complexProps[i];
                mergeComplexProps(name);
            }
        }
    ...
    function isPropsEqual(obj0, obj1) {
        for (var key0 in obj0) {
            if (hasOwnProperty.call(obj0, key0)) {
                if (!(key0 in obj1)) {
                    return false;
                }
            }
        ...
        for (var key1 in obj1) {
            if (hasOwnProperty.call(obj1, key1)) {
                if (obj0[key1] !== obj1[key1]) {
                    return false;
                }
            }
        }
        ...
        for (var defId in defs) {
            ...
            if (def.recurringDef) {
                ...
                for (var _i = 0, starts_1 = starts; _i < starts_1.length; _i++) {
                    ...
                    var newInstance = createEventInstance(defId, {
                        start: start,
    ...
    */
    ...
    var NativeFormatter = /** @class */ (function () {
        function NativeFormatter(formatSettings) {
            ...
            this.processFormatSettings(formatSettings);
            this.buildFormattingFunc = memoize(buildFormattingFunc);
        }
    
        NativeFormatter.prototype.processFormatSettings = function (formatSettings) {
            ...
            for (var name_1 in formatSettings) {
                if (name_1 in EXTENDED_SETTINGS_AND_SEVERITIES) {
                    ...
                    this.severity = Math.max(EXTENDED_SETTINGS_AND_SEVERITIES[name_1], this.severity);
                } else {
                    standardDateProps[name_1] = formatSettings[name_1];
                    if (name_1 in STANDARD_DATE_PROP_SEVERITIES) {
                        this.severity = Math.max(STANDARD_DATE_PROP_SEVERITIES[name_1], this.severity);
                    }
                }
            }
        };
        ...
        NativeFormatter.prototype.formatRange = function (start, end, context) {
            ...
            var biggestUnitForPartial = this.computeBiggestUnitForPartial(diffSeverity);
    
            if (biggestUnitForPartial > 1 && standardDateProps.year && standardDateProps.month && standardDateProps.day) {
        ...
        NativeFormatter.prototype.computeBiggestUnitForPartial = function (severity) {
            switch (severity) {
                case 7:
                case 6:
                case 5:
    ...
    */
    var CmdFormatter = CmdFormatter || /** @class */ (function () {
    ...
    var FuncFormatter = FuncFormatter || /** @class */ (function () {
...
if (typeof EventSourceApi === 'undefined') {
    ...
    */
    var ExternalDraggable = /** @class */ (function () {
        function ExternalDraggable(el, settings) {
            ...
            dragging.emitter.on('pointerdown', this.handlePointerDown);
            dragging.emitter.on('dragstart', this.handleDragStart);
            // Remove the instantiation of ExternalElementDragging
        }
